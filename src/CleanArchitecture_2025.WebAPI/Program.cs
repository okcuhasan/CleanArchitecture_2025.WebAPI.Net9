...
builder.Services.AddRateLimiter(r => r.AddFixedWindowLimiter("fixed", cfg =>
{
    cfg.QueueLimit = 100;
...
app.UseCors(c => c.AllowAnyHeader().AllowCredentials().AllowAnyMethod().SetIsOriginAllowed(t => true));
